...
public class CartItem {
	...
	public CartItem(int cartItemId, int userId, int foodId, int quantity, int totalPrice) {
		super();
		this.cartItemId = cartItemId;
		this.userId = userId;
		this.foodId = foodId;
	...
	public CartItem(int userId2, int foodId2, int quantity2, double totalPrice2) {
